...
def parse_arguments():
    ...
    vllm_group.add_argument("--endpoints_infer", type=str, nargs='+', required=True,
                            help="List of VLLM endpoints")
    vllm_group.add_argument("--endpoints_summary", type=str, nargs='+', required=True,
                            help="List of VLLM endpoints")
    vllm_group.add_argument("--model_path_infer", type=str, required=True,
                            help="Model path for tokenizer loading")
    vllm_group.add_argument("--model_path_summary", type=str, required=True,
                            help="Model path for tokenizer loading")
    vllm_group.add_argument("--api_keys", type=str, nargs='+', default=None,
                            help="List of API keys corresponding to endpoints")
    vllm_group.add_argument("--default_model_infer", type=str, default="Qwen2.5-7B-Instruct",
                            help="Default model name to use")
    vllm_group.add_argument("--default_model_summary", type=str, default="Qwen2.5-7B-Instruct",
                            help="Default model name to use")
    ...
    inference_group.add_argument("--max_rounds", type=int, default=5,
