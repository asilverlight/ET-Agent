...
EXPERIMENT_NAME="Efficiency_Qwen_7B_Stage3" # Modify experiment name
...
# Data file paths
TRAIN_FILES="/path/to/ARPO/rl_datasets/train_processed_stage3.parquet" # Modify training data path
VALID_FILES="/path/to/ARPO/rl_datasets/valid.parquet" # Modify validation data path

# ============================ Model Configuration ============================
# Actor model path
ACTOR_MODEL_PATH="/path/to/output/Efficiency_Qwen_7B_Stage2" # Modify training model path
