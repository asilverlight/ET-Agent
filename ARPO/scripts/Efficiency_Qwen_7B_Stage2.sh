...
EXPERIMENT_NAME="Efficiency_Qwen_7B_Stage2" # Modify experiment name
...
# Data file paths
TRAIN_FILES="/path/to/ARPO/rl_datasets/train_processed_stage2.parquet" # Modify training data path
