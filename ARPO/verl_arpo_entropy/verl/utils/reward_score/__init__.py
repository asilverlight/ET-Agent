...
def default_compute_score(data_source, solution_str, ground_truth, extra_info=None, sandbox_fusion_url=None, concurrent_semaphore=None):
    ...
    if data_source == "openai/gsm8k":
    ...
    elif data_source in ["lighteval/MATH", "DigitalLearningGmbH/MATH-lighteval", "math_effi_rl"]:
        from . import math
        ...
        res = deep_research.compute_score(solution_str, ground_truth)
    else:
