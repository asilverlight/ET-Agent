...
def parse_arguments():
    ...
    generation_group.add_argument("--use_log", action="store_true",
    ...
    inference_group.add_argument("--use_summarize", action="store_true",
                                 help="Whether to use summarize")
    ...
    tools_group.add_argument("--max_doc_length_without_summarize", type=int, default=1000,
                             help="Maximum length per search result without summarization")
    ...
    tools_group.add_argument("--use_serper", action="store_true",
                             help="Whether to use serper search")
    tools_group.add_argument("--serper_api_key", type=str, nargs='+', default=None,
                             help="Serper API keys")
