...
class Item:
    ...
    def __init__(self, item_dict: Dict[str, Any]) -> None:
        ...
        self.retrieval_results: List[str, Any] = item_dict.get("retrieval_results", [])
    ...
    def __getattr__(self, attr_name: str) -> Any:
        predefined_attrs = ["id", "question", "golden_answers", "metadata", "output", "choices", "retrieval_results"]
    ...
    def __setattr__(self, attr_name: str, value: Any) -> None:
        predefined_attrs = ["id", "question", "golden_answers", "metadata", "output", "choices", 'data', "retrieval_results"]
        if attr_name in predefined_attrs:
...
class Dataset:
    ...
    def _load_data(self, dataset_name: str, dataset_path: str) -> List[Item]:
        ...
        if dataset_path.endswith(".jsonl"):# or dataset_path.endswith(".json"):
            ...
            with open(dataset_path, "r", encoding="utf-8") as f:
                datas = json.load(f)
                                              #       /home/u2024001049/share/feifei/datasets/metarag/biomedical/process_test_datas.json
            # datas = random.sample(datas, 30)# 调试用 /home/u2024001049/share/feifei/datasets/metarag/biomedical/processed_test_datas.json
    ...
    def __getattr__(self, attr_name: str) -> List[Any]:
        ...
        使用示例:
        - dataset.question  # 获取所有问题
        - dataset.golden_answers  # 获取所有标准答案
        - dataset.id  # 获取所有ID
        - dataset.output  # 获取所有输出
        - dataset.retrieval_result  # 获取所有检索结果
        - dataset.prompt  # 获取所有提示
        - dataset.pred  # 获取所有预测结果
        - dataset.judge_result  # 获取所有判断结果
        
        对于任何在Item类中定义的属性，都可以通过dataset.属性名来访问。
        """
